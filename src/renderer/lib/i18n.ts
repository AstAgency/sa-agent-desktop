...
const dictionaries = {
  en: {
    ...
    "profile.search.endpoint": "OrioSearch endpoint",
    "profile.search.endpointHint": "URL of your self-hosted OrioSearch instance. Default: http://localhost:8000",
    "profile.search.save": "Save",
    "profile.search.saving": "Saving…",
    "profile.search.test": "Test connection",
    "profile.search.testOk": "Connection OK",
    "profile.search.testFail": "Connection failed",
  },
  ru: {
    "app.title": "SA-Agent Desktop",
    ...
    "profile.search.endpoint": "Адрес OrioSearch",
    "profile.search.endpointHint": "URL self-hosted OrioSearch. По умолчанию http://localhost:8000",
    "profile.search.save": "Сохранить",
    "profile.search.saving": "Сохранение…",
    "profile.search.test": "Проверить",
    "profile.search.testOk": "Соединение установлено",
    "profile.search.testFail": "Соединение не удалось",
  },
} as const;
