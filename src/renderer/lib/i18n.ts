...
const dictionaries = {
  en: {
    ...
    "profile.search.provider": "Provider",
    "profile.search.apiKey": "API key",
    "profile.search.test": "Test",
    "profile.search.testOk": "Web search configured successfully",
    "profile.search.testFail": "Web search test failed",
    "profile.search.none": "Not configured",
  },
  ru: {
    "app.title": "SA-Agent Desktop",
    ...
    "profile.search.provider": "Провайдер",
    "profile.search.apiKey": "API-ключ",
    "profile.search.test": "Проверить",
    "profile.search.testOk": "Веб-поиск настроен",
    "profile.search.testFail": "Проверка веб-поиска не удалась",
    "profile.search.none": "Не настроено",
  },
} as const;
