...
const dictionaries = {
  en: {
    ...
    "interaction.locked": "Wait for the agent to finish or press Stop before switching chats, changing the agent, or attaching files.",
    "chat.send": "Send",
    ...
    "usage.title": "Usage",
    "usage.tokenLimits": "Token Limits",
    "usage.imageLimits": "Image Analysis Limits",
    "usage.hourly": "Hour",
    "usage.daily": "Day",
    "usage.weekly": "Week",
    "usage.perHour": "Per hour",
    "usage.perDay": "Per day",
    "usage.perWeek": "Per week",
  ...
  ru: {
    ...
    "interaction.locked": "Дождитесь завершения работы агента или нажмите «Стоп», прежде чем переключать чаты, менять агента или прикреплять файлы.",
    "chat.send": "Отправить",
    ...
    "usage.tokenLimits": "Лимиты токенов",
    "usage.imageLimits": "Лимиты анализа изображений",
    "usage.hourly": "Час",
    "usage.daily": "День",
    "usage.weekly": "Неделя",
    "usage.perHour": "В час",
    "usage.perDay": "В день",
    "usage.perWeek": "В неделю",
    "usage.notAvailable": "Недоступно",
