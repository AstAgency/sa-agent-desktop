 ...
 *   6. orchestration_protocol           (only if agent carries one)
 *   7. <global_memory>                  (per profile)
 *   8. <project_memory>                 (per project)
 *   9. <relevant_context>               (semantic memory)
 *  10. <available_tools>                (manifest for the LLM)
 */
